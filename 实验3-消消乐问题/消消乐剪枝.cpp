...
unordered_map<int,int> visited;//状态储存，string储存01矩阵地图的状态，int储存相应的分数和操作次数 
...
//		}
//	}
//	if(visited[res]&&visited[res]>val)
//		return false;
//	visited[res]=val;
//	return true;
//}
...
int a[10]={8,8,8,8,8};// X
int b[10]={4,4,4,4,4};
int c[10]={4,4,4,4,4};
int d[10]={2,3,4,5,6};

//int a[10]={4,5,6,7,8};// N
//int b[10]={4,4,4,4,4};
//int c[10]={4,4,4,4,4};
//int d[10]={8,8,8,8,8};

//int b[10]={4,5,6,7,8};// M
//int a[10]={4,4,4,4,4};
//int c[10]={4,4,4,4,4};
//int d[10]={8,8,8,8,8};

//int a[10]={8,8,8,8,8};// K
//int b[10]={4,4,4,4,4};
//int c[10]={4,5,6,7,8};
//int d[10]={4,4,4,4,4};
...
{
	int k=1;// 
	//freopen("date6x6 4 8.txt","r",stdin);
	freopen("data8x4 4 8.txt","r",stdin);
	//freopen("data4x8 4 8.txt","r",stdin);
	cin>>N>>M>>K>>X;
	printf("N:%d M:%d K:%d X:%d\n",N,M,K,X);
	update_mod();
	int t=10;//
